...
const AIR_WEAPONS = {
  "AGM-45A": { speed:8.5, boostSeconds:2.5, airToAirFlight:{sustainSeconds:7,coastDragPerSecond:.032,minimumSpeedFactor:.48,loftAltitude:38,loftTransitionRange:115} },
  "AGM-88A": { speed:9.2, boostSeconds:2.8, airToAirFlight:{sustainSeconds:14,coastDragPerSecond:.018,minimumSpeedFactor:.55,loftAltitude:95,loftTransitionRange:260} },
  "Kh-31P-C": { speed:10.8, boostSeconds:3.2, airToAirFlight:{sustainSeconds:11,coastDragPerSecond:.023,minimumSpeedFactor:.5,loftAltitude:62,loftTransitionRange:210} },
};
