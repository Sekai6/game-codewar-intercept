...
const observation = {
  ...
  gciCommands: [{ id: "GCI-CMD-1", participantId: "red-MIG-29A-1", participantPosition: position(50, 60, -400), controllerTrackId: "GCI-a019", interceptPoint: position(-30, 72, -120), quality: .63, uncertainty: 22, commandedSpeed: 8.4, radarActivationRange: 300, commandMode: "automated", deliveredAt: 4, expiresAt: 18 }],
...
assert(acmi.includes("CommandMode=automated") && acmi.includes("RadarActivationRange=300"), "GCI doctrine metadata missing");
