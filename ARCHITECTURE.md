...
- Link 16 equipment is opt-in capability data on `AirPlatformDefinition`; it is not inferred from side or nationality. The current US F-14A and A-6E entries carry game-scaled terminals. Tu-16K and MiG-29A do not register, transmit, receive, or accumulate Link 16 tracks. A future Soviet data-link implementation must be a separate service with its own period capabilities.
