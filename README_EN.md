...
> Documentation snapshot: v1.20.0 · 2026-08-02<br>
> This page describes the v1.20.0 implementation; later versions may change mechanisms, visuals, and unit data.
...
[中文](README.md) · [English Wiki](wiki/en/README.md) · [Chinese Wiki](wiki/README.md) · [V1.20 Release](https://github.com/Sekai6/game-coldwar-intercept/releases/tag/v1.20.0) · [Changelog](CHANGELOG.md)
...
## v1.20.0 Surface-Combatant Asset Upgrade

v1.20.0 gives USS Long Beach (CGN-9), USS Lake Champlain (CG-57), and the Project 1164/Slava-class procedural assets a second modelling and LOD pass. Real hull dimensions, superstructure arrangement, and the relative placement of weapons and sensors guide the visual work, while gameplay-scaled performance and the existing ship-owned launcher/fire-control chain remain unchanged.

- Long Beach now preserves the real approximately `9.86:1` length-to-beam ratio, uses a corrected vertical scale, and carries a rebuilt NTU bow battery, aft flight deck, Mk 143 ABL, SPS-48/SPS-49, and SPG-55 silhouette.
- CG-57 separates the forward and aft AEGIS blocks, hangar, and equipment decks, with rebuilt SPY-1 faces, SPG-62 directors, lattice masts, rectangular uptakes, and corrected Mk 41/Mk 45 proportions.
- Project 1164 gains a stepped bridge, four paired P-500 launch groups per side, the S-300F field, Top Dome, Top Steer/Top Pair, AK-130, Osa, RBU, AK-630, and the aft aviation area.
- All three ships use quality-aware LOD. Standard quality retains class-defining silhouettes: the Long Beach command island keeps its crown and window bands, while CG-57 retains both Mk 41 banks through visual proxies placed at the operational launch-bank coordinates.

A dedicated surface-asset gallery captures 18 fixed Ultra/High/Standard views serially through one Chromium renderer and reports visible dimensions and triangle counts. Low-detail proxies are display-only and own no magazine, cell, hardpoint, or firing authority; runtime verification still requires CG-57 to complete physical departure from its own operational Mk 41 cells.
...
The current version line is `v1.20.0`, displayed as `V1.20` in the web HUD. Feature boundaries and verification evidence are listed in [CHANGELOG.md](CHANGELOG.md).
