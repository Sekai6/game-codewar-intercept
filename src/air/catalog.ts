...
export const AIR_PLATFORM_DEFINITIONS: readonly AirPlatformDefinition[] = [
  ...
  { id:"A-6E", name:"A-6E Intruder", nation:"United States", role:"All-weather strike", mission:"anti-ship", radarCrossSection:7, infraredSignature:1, flight:{cruiseSpeed:3.8,maxSpeed:5.5,stallSpeed:1.7,acceleration:0.62,drag:0.021,maxLoadFactor:6.5,maxRollRateDeg:95,maxPitchRateDeg:23,fuelSeconds:950,aerodynamics:a6Aerodynamics,thrust:attackThrust}, sensor:{name:"AN/APQ-148",range:340,updateInterval:1.2,fieldOfViewDeg:100,precision:0.78}, datalink:{link16:true,minimumEra:"link16-modernized",terminalName:"JTIDS Integration",terminalReliability:0.92,timeSyncQuality:0.95}, ecm:{strength:0.52,burnThroughRange:28}, countermeasures:{chaff:24,flares:24,program:{chaffBurst:2,flareBurst:2,interval:0.2,cooldown:5,triggerTti:18}}, loadout:{...emptyLoadout(),"AGM-84A":2}, fireControlChannels:{datalink:2,illumination:0}, hardpoints:intruderHardpoints, buildModel:createA6Model, shipDefenseTemplate:"Kh-22" },
