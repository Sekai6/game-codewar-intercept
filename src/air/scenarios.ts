...
function seadScenarioSpawns(): AirSpawn[] {
  const spawns = pair({ platformId:"A-6E", side:"blue", formationId:"SEAD-1", position:new THREE.Vector3(-80,28,-420), heading:new THREE.Vector3(.12,0,-1) });
